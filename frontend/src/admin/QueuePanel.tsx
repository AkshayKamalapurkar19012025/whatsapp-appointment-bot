...
// Doctors -> pick a doctor -> Queue tab. This puts it one click from
// the main nav, meant to be the screen staff or a doctor leaves open
// during a shift (QueueSection polls on its own).
